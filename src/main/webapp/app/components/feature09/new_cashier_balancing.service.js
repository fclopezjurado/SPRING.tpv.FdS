angular.module("tpv").service("newCashierBalancingService", function($http, $q) {
	"use strict";
	...
	const baseURL = "http://localhost:8080/SPRING.tpv.FdS.1.2.0-SNAPSHOT/api/v0/balances";

	
	this.create = function(cashierbalancing) {						
		return this.request({ method: 'POST', url: baseURL, data: cashierbalancing });
	}
});