angular.module("tpv").factory("createInvoiceService", function ($http) {
    const baseURL 			= "http://localhost:8080/SPRING.tpv.FdS.1.2.0-SNAPSHOT/api/v0/invoice";
    const responseMockWrong = "{\"error\": \"Not found\", \"code\": 404, \"data\": []}";
    const responseMockOK 	= "{\"error\": \"\", \"code\": 200, \"data\": [{\"id\": 25697, \"ticket_id\": 45896}]}";
     ...
     */
    return {
        create: function (ticketID) {
            var requestParameters = {params: {id: ticketID}};
