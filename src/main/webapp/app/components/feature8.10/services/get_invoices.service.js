angular.module("tpv").factory("getInvoicesService", function ($http) {
    const baseURL 			= "http://localhost:8080/SPRING.tpv.FdS.1.2.0-SNAPSHOT/api/v0/invoices";
    const responseMockWrong = "{\"error\": \"Not found\", \"code\": 404, \"data\": []}";
    const responseMockOK1 	= "{\"error\": \"\", \"code\": 200, \"data\": []}";
    const responseMockOK2 	= "{\"error\": \"\", \"code\": 200, \"data\": [{\"id\": 25697, \"ticket_id\": 45896}, " +
