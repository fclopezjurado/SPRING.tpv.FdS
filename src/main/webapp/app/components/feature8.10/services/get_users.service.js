angular.module("tpv").factory("getUsersService", function ($http) {
    ...
    const responseMockOK2 	= "{\"error\": \"\", \"code\": 200, \"data\": [{\"active\": 1, \"address\": \"Uclés St. 1\", " +
    		...
    		"\"registrationDate\": 1504389600000, \"username\": \"user2\"}]}";
    
    /**
     * TODO: This end-point will return a list of users wrappers. The user who uses this end point must be logged in and 
     * must be authorized.
     */
    return {
        getUsers: function () {
