...
public class VoucherResourceFunctionalTesting {
    ...
    public void searchVoucher() {
        ...
        List<VoucherWrapper> VoucherList = Arrays.asList(new RestBuilder<VoucherWrapper[]>(RestService.URL).path(Uris.VOUCHERS).path("/"+voucherWrapper.getReference()).clazz(VoucherWrapper[].class)
                .get().build());        
        ...
        VoucherList = Arrays.asList(new RestBuilder<VoucherWrapper[]>(RestService.URL).path(Uris.VOUCHERS).path("/all").clazz(VoucherWrapper[].class)
                .get().build());                
