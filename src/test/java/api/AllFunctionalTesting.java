...
@SuiteClasses({AdminResourceFunctionalTesting.class, UserResourceFunctionalTesting.class, TokenResourceFunctionalTesting.class,
        ...
        EmbroideryResourceFunctionalTesting.class, ProviderResourceFunctionalTesting.class, ProductResourceFunctionalTesting.class, TicketResourceFunctionalTesting.class})
